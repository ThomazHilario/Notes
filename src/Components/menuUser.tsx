    ...
    return(
        <Dialog.Root>
            <Dialog.Trigger className='bg-gray-950/30 w-60 rounded-md p-2'>
                <div className='flex'>
                    <img className='rounded-full h-11 w-11 object-cover' src={typeof img === 'string' ? img : 'https://images.unsplash.com/photo-1607346256330-dee7af15f7c5?&w=64&h=64&dpr=2&q=70&crop=focalpoint&fp-x=0.67&fp-y=0.5&fp-z=1.4&fit=crop'}  />
            ...
            <Dialog.Portal>
                <DialogContent className=' absolute top-20 right-1/2 translate-x-1/2 md:top-20 md:right-[1.20rem] md:translate-x-0 bg-gray-950/30 w-60  flex justify-center items-center flex-col gap-10 py-8'>
                 <div>
                    ...
                    {/* imagem de perfil */}
                    <img className='object-cover rounded-full h-20 w-20' src={typeof img === 'string' ? img : 'https://images.unsplash.com/photo-1607346256330-dee7af15f7c5?&w=64&h=64&dpr=2&q=70&crop=focalpoint&fp-x=0.67&fp-y=0.5&fp-z=1.4&fit=crop'} />
                 </div>
